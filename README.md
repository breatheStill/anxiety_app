...
Conflict Plan
If a disagreement arises within the group, an algorithm with the intention finding a resolution through a series of progressive steps.

The opposing parties will sit down with the team for an open discussion on the arguments at hand.
If after 20 minutes the issue is not resolved, a pros and cons list, and the team will make a deciding vote on it.
In the condition of a vote tie, the team will find a more senior member of the Code Fellows community and brief them on the issue and require their opinion on the issue. This will be the tie-breaking vote.
Communication Plan
...
Jokes on slack must have a JK or LOL and/or distinguished clearly from the rest of the slack messages.
